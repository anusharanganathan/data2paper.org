<?php
  ...
  function wp_notes_widget_default_settings_callback(  ) { 
    ...
    <p class="wp-notes-widget-limit-width" >
      <?php _e( 'Default settings for the widget and shortcode.', 'wp-notes-widget' ); ?>
    </p>
  ...
  function wp_notes_widget_default_shortcode_settings_callback(  ) { 
    ...
    <p class="wp-notes-widget-limit-width" >
      <?php _e( 'Default shortcode specific settings.', 'wp-notes-widget' ); ?>
    </p>
  ...
  function wp_notes_widget_twitter_key_callback(  ) { 
    ...
    ?>
      ...
      <div class="form-group">
        <label for="wp_notes_widget_twitter_credentials__api_key"><?php _e('API Key','wp-notes-widget'); ?></label>
  ...
  function wp_notes_widget_twitter_secret_callback(  ) { 
    ...
    ?>
      ...
      <div class="form-group">
        <label for="wp_notes_widget_twitter_credentials__api_secret"><?php _e('API Secret','wp-notes-widget'); ?></label>
  ...
  function wp_notes_widget_twitter_token_callback(  ) { 
    ...
    ?>
      ...
      <div class="form-group">
        <label for="wp_notes_widget_twitter_credentials__access-token"><?php _e('Access Token','wp-notes-widget'); ?></label>
  ...
  function wp_notes_widget_twitter_token_secret_callback(  ) { 
    ...
    ?>
      ...
      <div class="form-group">
        <label for="wp_notes_widget_twitter_credentials__token-secret"><?php _e('Token Secret','wp-notes-widget'); ?></label>
  ...
  add_settings_section(
    'wp_notes_widget_twitter_credentials',              // ID used to identify this section and with which to register options
     __('Twitter API Credentials','wp-notes-widget'),   // Title to be displayed on the administration page
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('API Key for your Twitter application','wp-notes-widget').'</small>',                                      // The label to the left of the option interface element
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('API Secret for your Twitter application','wp-notes-widget').'</small>',              
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Access Token for your Twitter application','wp-notes-widget').'</small>',              
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Token Secret for your Twitter application','wp-notes-widget').'</small>',              
  ...
  function wp_notes_widget_default_thumb_tack_color_callback() { 
    ...
    ?>
      <label for="wp_notes_widget_defaults--thumb_tack_color" ><?php _e('Thumb Tack Color', 'wp-notes-widget' ) ?></label>
      <select id="wp_notes_widget_defaults--thumb_tack_color" name='wp_notes_widget_defaults[thumb_tack_colour]' >
        <option value="red"     <?php selected( $default_val['thumb_tack_colour'], 'red' ); ?> >     <?php _e('Red', 'wp-notes-widget' ) ?></option>
        <option value="blue"    <?php selected( $default_val['thumb_tack_colour'], 'blue' ); ?> >    <?php _e('Blue', 'wp-notes-widget' ) ?></option>
        <option value="green"   <?php selected( $default_val['thumb_tack_colour'], 'green' ); ?> >   <?php _e('Green', 'wp-notes-widget' ) ?></option>
        <option value="gray"    <?php selected( $default_val['thumb_tack_colour'], 'gray' ); ?> >    <?php _e('Gray', 'wp-notes-widget' ) ?></option>
        <option value="orange"  <?php selected( $default_val['thumb_tack_colour'], 'orange' ); ?> >  <?php _e('Orange', 'wp-notes-widget' ) ?></option>
        <option value="pink"    <?php selected( $default_val['thumb_tack_colour'], 'pink' ); ?> >     <?php _e('Pink', 'wp-notes-widget' ) ?></option>
        <option value="teal"    <?php selected( $default_val['thumb_tack_colour'], 'teal' ); ?> >    <?php _e('Teal', 'wp-notes-widget' ) ?></option>
        <option value="yellow"  <?php selected( $default_val['thumb_tack_colour'], 'yellow' ); ?> >  <?php _e('Yellow', 'wp-notes-widget' ) ?></option>
      </select>
  ...
  function wp_notes_widget_default_background_callback() { 
    ...
    ?>
      <label for="wp_notes_widget_defaults--background_color" ><?php _e('Background Color', 'wp-notes-widget' ) ?></label>
      <select id="wp_notes_widget_defaults--background_color" name='wp_notes_widget_defaults[background_colour]' >
        <option value="yellow"      <?php selected( $default_val['background_colour'], 'yellow' ); ?> >    <?php _e('Yellow', 'wp-notes-widget' ) ?>      </option>
        <option value="blue"        <?php selected( $default_val['background_colour'], 'blue' ); ?> >      <?php _e('Blue', 'wp-notes-widget' ) ?>        </option>
        <option value="green"       <?php selected( $default_val['background_colour'], 'green' ); ?> >     <?php _e('Green', 'wp-notes-widget' ) ?>      </option>
        <option value="pink"        <?php selected( $default_val['background_colour'], 'pink' ); ?> >      <?php _e('Pink', 'wp-notes-widget' ) ?>        </option>
        <option value="orange"      <?php selected( $default_val['background_colour'], 'orange' ); ?> >    <?php _e('Orange', 'wp-notes-widget' ) ?>      </option>
        <option value="white"       <?php selected( $default_val['background_colour'], 'white' ); ?> >     <?php _e('White', 'wp-notes-widget' ) ?>      </option>
        <option value="dark-grey"   <?php selected( $default_val['background_colour'], 'dark-grey' ); ?> > <?php _e('Dark Grey', 'wp-notes-widget' ) ?>  </option>
        <option value="light-grey"  <?php selected( $default_val['background_colour'], 'light-grey' ); ?> ><?php _e('Light Grey', 'wp-notes-widget' ) ?>  </option>
      </select>
  ...
  function wp_notes_widget_default_text_color_callback() { 
    ...
    ?>
      <label for="wp_notes_widget_defaults--text_color" ><?php _e('Text Color', 'wp-notes-widget' ) ?></label>
      <select id="wp_notes_widget_defaults--text_color" name='wp_notes_widget_defaults[text_colour]' >
        <option value="red"         <?php selected( $default_val['text_colour'], 'red' ); ?> >  <?php _e('Red', 'wp-notes-widget' ) ?>        </option>
        <option value="blue"        <?php selected( $default_val['text_colour'], 'blue' ); ?> >  <?php _e('Blue', 'wp-notes-widget' ) ?>        </option>
        <option value="black"       <?php selected( $default_val['text_colour'], 'black' ); ?> >  <?php _e('Black', 'wp-notes-widget' ) ?>      </option>
        <option value="pink"        <?php selected( $default_val['text_colour'], 'pink' ); ?> >  <?php _e('Pink', 'wp-notes-widget' ) ?>        </option>
        <option value="white"       <?php selected( $default_val['text_colour'], 'white' ); ?> >  <?php _e('White', 'wp-notes-widget' ) ?>      </option>
        <option value="dark-grey"   <?php selected( $default_val['text_colour'], 'dark-grey' ); ?> >  <?php _e('Dark Grey', 'wp-notes-widget' ) ?>  </option>
        <option value="light-grey"  <?php selected( $default_val['text_colour'], 'light-grey' ); ?> >  <?php _e('Light Grey', 'wp-notes-widget' ) ?>  </option>
      </select>
  ...
  function wp_notes_widget_default_font_size_callback() { 
    ...
    ?>
      <div class="form-group">
        <label for="wp_notes_widget_defaults--font_size" ><?php _e('Font Size', 'wp-notes-widget' ) ?></label>
        <select id="wp_notes_widget_defaults--font_size" name='wp_notes_widget_defaults[font_size]' >
          <option value="minus-50" <?php selected( $default_val['font_size'], 'minus-50' ); ?> > <?php _e('50% smaller', 'wp-notes-widget' ) ?>  </option>
          <option value="minus-45" <?php selected( $default_val['font_size'], 'minus-45' ); ?> > <?php _e('45% smaller', 'wp-notes-widget' ) ?>  </option>
          <option value="minus-40" <?php selected( $default_val['font_size'], 'minus-40' ); ?> > <?php _e('40% smaller', 'wp-notes-widget' ) ?>  </option>
          <option value="minus-35" <?php selected( $default_val['font_size'], 'minus-35' ); ?> > <?php _e('35% smaller', 'wp-notes-widget' ) ?>  </option>
          <option value="minus-30" <?php selected( $default_val['font_size'], 'minus-30' ); ?> > <?php _e('30% smaller', 'wp-notes-widget' ) ?>  </option>
          <option value="minus-25" <?php selected( $default_val['font_size'], 'minus-25' ); ?> > <?php _e('25% smaller', 'wp-notes-widget' ) ?>  </option>
          <option value="minus-20" <?php selected( $default_val['font_size'], 'minus-20' ); ?> > <?php _e('20% smaller', 'wp-notes-widget' ) ?>  </option>
          <option value="minus-15" <?php selected( $default_val['font_size'], 'minus-15' ); ?> > <?php _e('15% smaller', 'wp-notes-widget' ) ?>  </option>
          <option value="minus-10" <?php selected( $default_val['font_size'], 'minus-10' ); ?> > <?php _e('10% smaller', 'wp-notes-widget' ) ?>  </option>
          <option value="minus-5"  <?php selected( $default_val['font_size'], 'minus-5' ); ?> > <?php _e('5% smaller', 'wp-notes-widget' ) ?>  </option>
          
          <option value="normal" <?php selected( $default_val['font_size'], 'normal' ); ?> >    <?php _e('Normal', 'wp-notes-widget' ) ?></option>
          
          <option value="plus-5"  <?php selected( $default_val['font_size'], 'plus-5' ); ?> >   <?php _e('5% larger', 'wp-notes-widget' ) ?>  </option>
          <option value="plus-10" <?php selected( $default_val['font_size'], 'plus-10' ); ?> >  <?php _e('10% larger', 'wp-notes-widget' ) ?>  </option>
          <option value="plus-15" <?php selected( $default_val['font_size'], 'plus-15' ); ?> >  <?php _e('15% larger', 'wp-notes-widget' ) ?>  </option>
          <option value="plus-20" <?php selected( $default_val['font_size'], 'plus-20' ); ?> >  <?php _e('20% larger', 'wp-notes-widget' ) ?>  </option>
          <option value="plus-25" <?php selected( $default_val['font_size'], 'plus-25' ); ?> >  <?php _e('25% larger', 'wp-notes-widget' ) ?>  </option>
          <option value="plus-30" <?php selected( $default_val['font_size'], 'plus-30' ); ?> >  <?php _e('30% larger', 'wp-notes-widget' ) ?>  </option>
          <option value="plus-35" <?php selected( $default_val['font_size'], 'plus-35' ); ?> >  <?php _e('35% larger', 'wp-notes-widget' ) ?>  </option>
          <option value="plus-40" <?php selected( $default_val['font_size'], 'plus-40' ); ?> >  <?php _e('40% larger', 'wp-notes-widget' ) ?>  </option>
          <option value="plus-45" <?php selected( $default_val['font_size'], 'plus-45' ); ?> >  <?php _e('45% larger', 'wp-notes-widget' ) ?>  </option>
          <option value="plus-50" <?php selected( $default_val['font_size'], 'plus-50' ); ?> >  <?php _e('50% larger', 'wp-notes-widget' ) ?>  </option>
        </select>
      </div>
    <?php
  }
  ...
  function wp_notes_widget_default_display_date_callback() { 
    ...
    ?>
      <div class="checkbox">
        <label >
        <input type='checkbox' id="wp_notes_widget_defaults--display_date" <?php checked($default_val['show_date'], 'checked'); ?> name='wp_notes_widget_defaults[show_date]' value='checked' ><?php _e('Display Date','wp-notes-widget'); ?></label>
      </div>
    <?php
  }
  ...
  function wp_notes_widget_default_use_own_css_callback() { 
    ...
    ?>
      <div class="checkbox">
        ...
        <input type='checkbox' id="wp_notes_widget_defaults--use_own_css" <?php checked($default_val['use_custom_style'], 'checked'); ?> name='wp_notes_widget_defaults[use_custom_style]' value='checked' ><?php _e('Use Custom CSS','wp-notes-widget'); ?></label>
      </div>
    <?php
  }
  ...
  function wp_notes_widget_default_hide_if_empty_callback() { 
    ...
    ?>
      ...
      <div class="checkbox">
        <label><input type='checkbox' id="wp_notes_widget_defaults--hide_if_empty" <?php checked($default_val['hide_if_empty'], 'checked'); ?> name='wp_notes_widget_defaults[hide_if_empty]' value='checked' ><?php _e('Hide if Empty','wp-notes-widget'); ?></label>
      </div>
  ...
  function wp_notes_widget_default_use_individual_notes_callback() { 
    ...
    ?>
      <div class="checkbox">
        ...
        <input type='checkbox' id="wp_notes_widget_defaults--use_individual_notes" <?php checked($default_val['multiple_notes'], 'checked'); ?> name='wp_notes_widget_defaults[multiple_notes]' value='checked' ><?php _e('Use Individual Notes','wp-notes-widget'); ?></label>
      </div>
    <?php
  }
  ...
  function wp_notes_widget_default_enable_social_sharing_callback() { 
    ...
    ?>
      <div class="checkbox">
        ...
        <input type='checkbox' id="wp_notes_widget_defaults--enable_social_sharing" <?php checked($default_val['enable_social_share'], 'checked'); ?> name='wp_notes_widget_defaults[enable_social_share]' value='checked' ><?php _e('Enable Social Sharing','wp-notes-widget'); ?></label>
      </div>
    <?php
  }
  ...
  function wp_notes_widget_default_do_not_force_uppercase_callback() { 
    ...
    ?>
      ...
      <div class="checkbox">
        <label><input type='checkbox' id="wp_notes_widget_defaults--do_not_force_uppercase" <?php checked($default_val['do_not_force_uppercase'], 'checked'); ?> name='wp_notes_widget_defaults[do_not_force_uppercase]' value='checked' ><?php _e('Do not Force Uppercase Letters','wp-notes-widget'); ?></label>
      </div>
          ...
          <?php
            foreach ($font_mapping as $key => $font_mapping_item) {
              ...
              <li class="wp-notes-widget__settings__radio-checkbox-input-item font-style-item font-<?php echo $key ?>" >
                ...
                <label for="<?php echo $key ; ?>" id="font-selection-<?php echo $key ?>-label"  ><?php _e('Font Style','wp-notes-widget'); ?> - <?php echo $font_mapping_item ?></label>
              </li>
              <?php
            }
          ?>
  ...
  add_settings_section(
    ...
    __('Default Settings','wp-notes-widget'),                                 // Title to be displayed on the administration page
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Thumb tack color for notes','wp-notes-widget').'</small>',                                   // The label to the left of the option interface element
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Background color for notes','wp-notes-widget').'</small>',
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Text color for notes','wp-notes-widget').'</small>',
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Font size for notes','wp-notes-widget').'</small>',
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Display the publish date of the note','wp-notes-widget').'</small>',
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Do not include the built in CSS for the notes','wp-notes-widget').'</small>',
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('If there are no notes to display, hide the note container','wp-notes-widget').'</small>',
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Instead of one tall note, show multiple individual notes','wp-notes-widget').'</small>',
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Display a Twitter link below each note','wp-notes-widget').'</small>',
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Do not convert all the text to uppercase letters','wp-notes-widget').'</small>', 
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Font style for the note','wp-notes-widget').'</small>', 
  ...
  function wp_notes_widget_default_shortcode__max_width_callback() { 
    ...
    ?>
      ...
      <div class="form-group">
        <label for="wp_notes_widget__shortcode-defaults__max-width"><?php _e('Max Width','wp-notes-widget'); ?></label>
  ...
  function wp_notes_widget_default_shortcode__max_width_units_callback() { 
    ...
    ?>
    <div class="form-group">
      <label for="wp_notes_widget__shortcode-defaults__max-width-units" ><?php _e('Max Width Units','wp-notes-widget'); ?></label>
  ...
  function wp_notes_widget_default_shortcode__alignment_callback() { 
    ...
    ?>
    <label for="wp-notes-widget__settings__alignment-container" ><?php _e('Alignment','wp-notes-widget'); ?></label>
    <div id="wp-notes-widget__settings__alignment-container" >
      <label class="radio-inline"><input type="radio" name="wp_notes_widget_default_shortcode_settings[alignment]" <?php checked( $default_setting_val['alignment'], 'left' ); ?> value="left"><?php _e('Left','wp-notes-widget'); ?></label>
      <label class="radio-inline"><input type="radio" name="wp_notes_widget_default_shortcode_settings[alignment]" <?php checked( $default_setting_val['alignment'], 'center' ); ?> value="center"><?php _e('Center','wp-notes-widget'); ?></label>
      <label class="radio-inline"><input type="radio" name="wp_notes_widget_default_shortcode_settings[alignment]" <?php checked( $default_setting_val['alignment'], 'right' ); ?> value="right"><?php _e('Right','wp-notes-widget'); ?></label>
    </div>
  ...
  function wp_notes_widget_default_shortcode__direction_callback() { 
    ...
    ?>
    <label for="wp-notes-widget__settings__direction-options" ><?php _e('Direction','wp-notes-widget'); ?></label>
    <div class="wp-notes-widget__settings__direction-options">
      <label class="radio-inline"><input type="radio" name="wp_notes_widget_default_shortcode_settings[direction]" <?php checked( $default_setting_val['direction'], 'vertical' ); ?> value="vertical"><?php _e('Vertical','wp-notes-widget'); ?></label>
      <label class="radio-inline"><input type="radio" name="wp_notes_widget_default_shortcode_settings[direction]" <?php checked( $default_setting_val['direction'], 'horizontal' ); ?> value="horizontal"><?php _e('Horizontal','wp-notes-widget'); ?></label>
    </div>
  ...
  add_settings_section(
    'wp_notes_widget_default_shortcode_settings',                 // ID used to identify this section and with which to register options
     __('Default Shortcode Settings','wp-notes-widget'),                                // Title to be displayed on the administration page
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Max width of the note container','wp-notes-widget').'</small>',
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('CSS units of the max width note container','wp-notes-widget').'</small>', 
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Alignment of the note container','wp-notes-widget').'</small>', 
  ...
  add_settings_field( 
    ...
    '<small class="text-muted" >'.__('Direction flow of the notes','wp-notes-widget').'</small>', 
