  ...
  public function enqueue_scripts($hook) {
    ...
    if   ( 
      ...
      $translation_array = array(
        'audio_choose'    => __( 'Choose an audio file for the note', 'wp-notes-widget' ),
        'audio_add'       => __( 'Add Audio', 'wp-notes-widget' ),
        'image_choose'    => __( 'Choose an image for the note', 'wp-notes-widget' ),
        'image_add'       => __( 'Add Image', 'wp-notes-widget' ),
        'download_choose' => __( 'Choose an file to attach as a download', 'wp-notes-widget' ),
        'download_add'    => __( 'Add Download', 'wp-notes-widget' )
      );
