  <div class="wp-notes-post-admin-container" >
    ...
    <div class="content-segment">
      ...
      <script>
        ...
        var wp_notes_widget_twitter_over_limit_text         = "<?php _e('Too long. Tweet won\'t be sent.', 'wp-notes-widget'); ?>";  
      </script>
    ...
    <div class="content-segment">
      ...
      <textarea id="WP_Notes_tweet_body" name="WP_Notes_tweet_body" class="wp-notes-textarea" placeholder="<?php _e('Here is a tweet with a link to *url*. Also, check out this cool video *video*', 'wp-notes-widget'); ?>" ><?php echo $wp_notes_twitter_data['tweet_body']; ?></textarea>
      <ul class="faded" >
        <li><?php _e('Enter *url* in tweet body to attach the action or download link.', 'wp-notes-widget'); ?></li> 
        <li><?php _e('Enter *video* in tweet body to attach the video link.', 'wp-notes-widget'); ?></li>         
        <li><?php _e('If an image is attached to the note, it will automatically be included in your Tweet.', 'wp-notes-widget'); ?> </li>
      </ul>
