          ...
          <form method="post" action="options.php">
            ...
            <div class="" >
              ...
              <ul id="wp-notes-widget__settings-tab-list" class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#general" aria-controls="home" role="tab" data-toggle="tab"><?php _e('General','wp-notes-widget'); ?></a></li>
                <li role="presentation" class=""><a href="#shortcode" aria-controls="shortcode" role="tab" data-toggle="tab"><?php _e('Shortcode','wp-notes-widget'); ?></a></li>
                <li role="presentation"><a href="#twitter" aria-controls="profile" role="tab" data-toggle="tab"><?php _e('Twitter','wp-notes-widget'); ?></a></li>
              </ul>
