        ...
        <div class="crp-project-details-wrapper">
            ...
            <section class="crp-project-images-wrapper">
                <div class="crp-add-picture-button-wrapper">
                    ...
                    <a id="crp-add-youtube-button" class='button-secondary crp-add-picture-button crp-glazzed-btn crp-glazzed-btn-green tooltip' title='<?php echo htmlentities('<div class="crp-tooltip-content">Upgrade to Premium version for Youtube videos.</div>'); ?>' href='#'>+ Add Youtube Video</a>
                </div>
...
function crp_updateUI(){
    ...
    if(crp_portfolio.projects && crp_portfolio.corder){
        for(var crp_projectIndex = 0; crp_projectIndex < crp_portfolio.corder.length; crp_projectIndex++){
            ...
            var thumb_img = "<?php echo ($crp_theme == 'dark') ? '/general/glazzed-image-placeholder-thumb_dark.png' : '/general/glazzed-image-placeholder-thumb.png'; ?>";
