...
<div class="wp-notes-widget-container <?php if (!(bool)$use_custom_style)  echo 'use-wp-notes-style'  ?>  <?php if ( !((bool)$title) )  echo 'wp-notes-no-title'  ?>">
  <div class="wp-notes-widget  <?php if ( ((bool)$do_not_force_uppercase) )  echo 'do-not-force-uppercase';  ?> font-style-<?php echo $font_style ?> background-colour-<?php echo $background_colour ?> text-colour-<?php echo $text_colour ?> font-size-<?php echo $font_size ?> ">
